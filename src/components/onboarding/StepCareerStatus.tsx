...
import { CAREER_STATUS_OPTIONS } from '@/lib/profile';
import type { CareerStatus } from '@/types';

interface StepCareerStatusProps {
  value: CareerStatus | null;
  onChange: (status: CareerStatus) => void;
}

const ICONS: Record<CareerStatus, React.ReactNode> = {
  student: (
  ...
  executive: (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 0H12" />
    </svg>
  ),
  career_changer: (
    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function StepCareerStatus({ value, onChange }: StepCareerStatusProps) {
  return (
    <div className="flex flex-col items-center">
      ...
      <BlurFade delay={0.1}>
        <p className="mb-10 text-center text-[var(--text-secondary)]">
          We&apos;ll tailor your prep based on your career stage.
        </p>
      </BlurFade>
